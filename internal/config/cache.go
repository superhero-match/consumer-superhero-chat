...
type Cache struct {
	...
	MessagesKeyFormat      string `env:"CONSUMER_SUPERHERO_CHAT_REDIS_MESSAGES_KEY_FORMAT" yaml:"message_key_format" default:"messages.for.%s"`
	TokenKeyFormat         string `env:"CONSUMER_SUPERHERO_CHAT_REDIS_TOKEN_KEY_FORMAT" yaml:"token_key_format" default:"token.%s"`
}
